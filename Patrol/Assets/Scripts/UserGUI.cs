...
public class UserGUI : MonoBehaviour {
    ...
    private void OnGUI()
    {
        ...
        {
            GUI.Label(new Rect(Screen.width / 2 - 50, Screen.width / 2 - 180, 100, 100), "游戏结束", over_style);
        ...
        {
            GUI.Label(new Rect(Screen.width / 2 - 50, Screen.width / 2 - 100, 100, 100), "成功通关！", over_style);
            if (GUI.Button(new Rect(Screen.width / 2 - 50, Screen.width / 2 - 150, 100, 50), "重新开始"))
            {
                //重新开始
                action.Restart();
        ...
        if(show_time > 0)
        {
            ...
            GUI.Label(new Rect(Screen.width / 2 - 87, 50, 100, 100), "       获得10分通过", text_style);
        }
    }
